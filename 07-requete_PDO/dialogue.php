...
$pdo = new PDO("mysql:host=localhost;dbname=dialogue","root","root",array(PDO::ATTR_ERRMODE=>PDO::ERRMODE_WARNING));
//var_dump($pdo);
...
if( $_POST ){
    ...
    //Exemple de failles :
    // $pdo->query(" 
    //     INSERT INTO commentaire( pseudo, date_enregistrement, message ) 
...
// Ici on récupère TOUTES les informations provenant de la table 'commentaire' ORDONNEES par id_commentaire dans l'ordre DECROISSANT, donc le dernier sera affiche en premier
