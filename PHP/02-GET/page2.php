...
/*
Pour faire passer des informations dans l'URL, il faut commencer par un "?" et ensuite une 'cle' suivi du symbole '=' et de la valeur correspondante. SI l'on souhaite passer plusieurs infos dans l'URL, il suffit de les separer par un "&"

    page2.php?article=jean&couleur=rouge&prix=123
<=>
    fichier.php?cle=valeur&cle1=valeur1&cle2=valeur2

Pour recuperer les valeurs passees dans l'URL, il faut preciser la cle entre crochets avec la superglobale $_GET, car toutes les superglobales de PHP renvoient des arrays !!
*/