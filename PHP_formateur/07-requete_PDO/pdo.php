...
=> EXEC() :
	...
	=> INSERT, UPDATE, DELETE :
		...
		exec() renvoi le nombre de lignes affectées par la requête
...
//-------------------------------------------------------------------
//MODIFICATION :
$pdo->exec(" UPDATE employes SET salaire = 4444 WHERE id_employes = 992 ");
...
//-------------------------------------------------------------------
//SUPPRESSION :
$pdo->exec(" DELETE FROM employes WHERE id_employes = 992 ");
